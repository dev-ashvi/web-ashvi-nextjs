          ...
          <div className="parent">
                  <div className="card">
                      ...
                      <div className="content">
                          <span className="title">Indiviuals</span>
                          <span className="text">For Tech Enthusiasts to Budding Entrepreneurs</span>
                      </div>
                ...
                <div className="parent">
                  <div className="card">
                      ...
                      <div className="content">
                          ...
                          <span className="text">For Early-Stage to Venture-Funded Businesses</span>
                      </div>
                      <div className="bottom">
                ...
                <div className="parent">
                  <div className="card">
                      ...
                      <div className="glass"></div>
                      <div className="content">
                          <span className="title">Small Business</span>
                          <span className="text">For Local Businesses to Growing Businesses</span>
                      </div>
                      <div className="bottom">
                ...
                <div className="parent">
                  <div className="card">
                      ...
                      <div className="glass"></div>
                      <div className="content">
                          <span className="title">Enterprises</span>
                          <span className="text">For Established Firms to Global Corporations</span>
                      </div>
                      <div className="bottom">
